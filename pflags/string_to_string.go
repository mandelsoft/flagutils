...
func StringToString(f *pflag.FlagSet, name string, value map[string]string, usage string) *map[string]string {
	p := new(map[string]string)
	StringToStringVarP(f, p, name, "", value, usage)
	return p
}

func StringToStringP(f *pflag.FlagSet, name, shorthand string, value map[string]string, usage string) *map[string]string {
	p := new(map[string]string)
	StringToStringVarP(f, p, name, shorthand, value, usage)
	return p
}
