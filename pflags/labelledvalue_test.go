...
var _ = Describe("yaml flags", func() {
	...
	It("rejects invalid value", func() {
		...
		Expect(err.Error()).To(testutils.StringEqualWithContext("invalid argument \"a={\\\"a\\\":\\\"va\\\"\" for \"--flag\" flag: failed to parse YAML: \"{\\\"a\\\":\\\"va\\\"\": error converting YAML to JSON: yaml: line 1: did not find expected ',' or '}'"))
	})
