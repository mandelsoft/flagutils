...
type History = history.History[Key]
...
var _ tree.Object[Key] = (*Elem)(nil)

func (e *Elem) GetHistory() History {
	return e.History
}

func (e *Elem) IsNode() *Key {
	if e.Node {
		n := e.Data
		return &n
	}
...
func Check(t tree.TreeObjects[Key], result string) {
