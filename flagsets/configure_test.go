...
func adder(opts flagsets.Options, data flagsets.Config) error {
...
var _ = Describe("configure", func() {
	var sett1 flagsets.OptionTypeSet
	var sett2 flagsets.OptionTypeSet

	var prov flagsets.TypedOptionSetConfigProvider
	var flags *pflag.FlagSet
	var opts flagsets.Options
